...
void get_lame_short_version ( char *strbuf, size_t buflen, const char *prefix );
...
void get_lame_url ( char *strbuf, size_t buflen, const char *prefix );   /* Removes the nasty LAME_URL macro */
