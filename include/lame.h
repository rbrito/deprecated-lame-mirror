...
unsigned long CDECL lame_get_num_samples(const lame_t);

/* input sample rate in Hz.  default = 44100hz */
int CDECL lame_set_in_samplerate(lame_t, int);
int CDECL lame_get_in_samplerate(const lame_t);

/* number of channels in input stream. default=2  */
int CDECL lame_set_num_channels(lame_t, int);
int CDECL lame_get_num_channels(const lame_t);
...
float CDECL lame_get_scale(const lame_t );
...
float CDECL lame_get_scale_left(const lame_t );
...
float CDECL lame_get_scale_right(const lame_t );
...
int CDECL lame_get_out_samplerate(const lame_t );
...
int CDECL lame_get_bWriteVbrTag(const lame_t );

/* 1=decode only.  use lame/mpglib to convert mp3/ogg to wav.  default=0 */
int CDECL lame_set_decode_only(lame_t , int);
int CDECL lame_get_decode_only(const lame_t );

/* 1=encode a Vorbis .ogg file.  default=0 */
int CDECL lame_set_ogg(lame_t , int);
int CDECL lame_get_ogg(const lame_t );
...
int CDECL lame_get_quality(const lame_t );
...
MPEG_mode CDECL lame_get_mode(const lame_t );
...
int CDECL lame_get_force_ms(const lame_t );

/* use free_format?  default = 0 (disabled) */
int CDECL lame_set_free_format(lame_t , int);
int CDECL lame_get_free_format(const lame_t );
 ...
 */
int CDECL lame_set_errorf(lame_t ,
                          void (*func)(const char *, va_list));
int CDECL lame_set_debugf(lame_t ,
                          void (*func)(const char *, va_list));
int CDECL lame_set_msgf  (lame_t ,
                          void (*func)(const char *, va_list));
...
int CDECL lame_get_brate(const lame_t );
int CDECL lame_set_compression_ratio(lame_t , float);
float CDECL lame_get_compression_ratio(const lame_t );


int CDECL lame_set_asm_optimizations( lame_t gfp, int, int );
...
int CDECL lame_get_copyright(const lame_t );

/* mark as original.  default=1 */
int CDECL lame_set_original(lame_t , int);
int CDECL lame_get_original(const lame_t );

/* error_protection.  Use 2 bytes from each frame for CRC checksum. default=0 */
int CDECL lame_set_error_protection(lame_t , int);
int CDECL lame_get_error_protection(const lame_t );

/* MP3 'private extension' bit  Meaningless.  default=0 */
int CDECL lame_set_extension(lame_t , int);
int CDECL lame_get_extension(const lame_t );

/* enforce strict ISO compliance.  default=0 */
int CDECL lame_set_strict_ISO(lame_t , int);
int CDECL lame_get_strict_ISO(const lame_t );
 
void CDECL lame_set_forbid_diff_blocktype( lame_t gfp, int val );
...
int CDECL lame_get_disable_reservoir(const lame_t );

/* Naoki's psycho acoustic model.  default=0 */
int CDECL lame_set_exp_nspsytune(lame_t , int);
int CDECL lame_get_exp_nspsytune(const lame_t );

void CDECL lame_set_msfix(lame_t , double);
...
vbr_mode CDECL lame_get_VBR(const lame_t );

/* VBR quality level.  0=highest  9=lowest  */
int CDECL lame_set_VBR_q(lame_t , int);
int CDECL lame_get_VBR_q(const lame_t );

/* Ignored except for VBR=vbr_abr (ABR mode) */
int CDECL lame_set_VBR_mean_bitrate_kbps(lame_t , int);
int CDECL lame_get_VBR_mean_bitrate_kbps(const lame_t );

int CDECL lame_set_VBR_min_bitrate_kbps(lame_t , int);
int CDECL lame_get_VBR_min_bitrate_kbps(const lame_t );

int CDECL lame_set_VBR_max_bitrate_kbps(lame_t , int);
int CDECL lame_get_VBR_max_bitrate_kbps(const lame_t );
...
int CDECL lame_get_lowpassfreq(const lame_t );
/* width of transition band, in Hz.  Default = one polyphase filter band */
int CDECL lame_set_lowpasswidth(lame_t , int);
int CDECL lame_get_lowpasswidth(const lame_t );

/* freq in Hz to apply highpass. Default = 0 = lame chooses.  -1 = disabled */
int CDECL lame_set_highpassfreq(lame_t , int);
int CDECL lame_get_highpassfreq(const lame_t );
/* width of transition band, in Hz.  Default = one polyphase filter band */
int CDECL lame_set_highpasswidth(lame_t , int);
int CDECL lame_get_highpasswidth(const lame_t );
...
int CDECL lame_get_ATHonly(const lame_t );

/* only use ATH for short blocks */
int CDECL lame_set_ATHshort(lame_t , int);
int CDECL lame_get_ATHshort(const lame_t );

/* disable ATH */
int CDECL lame_set_noATH(lame_t , int);
int CDECL lame_get_noATH(const lame_t );
...
float CDECL lame_get_ATHlower(const lame_t );

/* adjust (in dB) the point below which adaptive ATH level adjustment occurs */
int CDECL lame_set_athaa_sensitivity( lame_t , float);
float CDECL lame_get_athaa_sensitivity( const lame_t );
...
float CDECL lame_get_interChRatio(const lame_t );
...
int CDECL lame_get_emphasis(const lame_t );
...
int CDECL lame_get_version(const lame_t );

/* encoder delay   */
int CDECL lame_get_encoder_delay(const lame_t );
...
*/
int CDECL lame_get_encoder_padding(const lame_t );

/* size of MPEG frame */
int CDECL lame_get_framesize(const lame_t );

/* number of PCM samples buffered, but not yet encoded to mp3 data. */
int CDECL lame_get_mf_samples_to_encode( const lame_t  gfp );
...
*/
int CDECL lame_get_size_mp3buffer( const lame_t  gfp );

/* number of frames encoded so far */
int CDECL lame_get_frameNum(const lame_t );

/*
  lame's estimate of the total number of frames to be encoded
   only valid if calling program set num_samples
*/
int CDECL lame_get_totalframes(const lame_t );
 ...
 */
int CDECL lame_init_params(lame_t  const );
 ...
 */
void CDECL lame_print_config(const lame_t  gfp);

void CDECL lame_print_internals( const lame_t gfp);
...
int CDECL lame_encode_buffer (
        lame_t  gfp,           /* global context handle         */
...
int CDECL lame_encode_buffer_interleaved(
        lame_t  gfp,           /* global context handlei        */
...
void CDECL lame_block_type_hist(const lame_t, int btype_count[6]);
...
extern void id3tag_init   (lame_t gfp);

/* force addition of version 2 tag */
extern void id3tag_add_v2   (lame_t gfp);

/* add only a version 1 tag */
extern void id3tag_v1_only  (lame_t gfp);

/* add only a version 2 tag */
extern void id3tag_v2_only  (lame_t gfp);

/* pad version 1 tag with spaces instead of nulls */
extern void id3tag_space_v1 (lame_t gfp);

/* pad version 2 tag with extra 128 bytes */
extern void id3tag_pad_v2   (lame_t gfp);
