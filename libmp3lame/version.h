...
# define LAME_ALPHA_VERSION      13     /* Patch level of alpha version, otherwise zero */
...
# define PSY_ALPHA_VERSION       5      /* Set number if this is an alpha version, otherwise zero */
