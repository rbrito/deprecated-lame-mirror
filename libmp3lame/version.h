...
# define LAME_ALPHA_VERSION      4      /* Patch level of alpha version, otherwise zero */
...
# define PSY_ALPHA_VERSION       1      /* Set number if this is an alpha version, otherwise zero */
