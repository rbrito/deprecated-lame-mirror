...
/*#define TEST_0812*/
    ...
    /*vbr_q  qcomp_l  qcomp_s  expY  st_lrm   st_s  mask adj_l  adj_s  ath_lower  ath_curve  ath_sens  interChR  safejoint sfb21mod  msfix */
        {0,       9,       9,    0,   4.20,  25.0,      -7.0,   -4.0,       7.5,       1,          0,   0,              2,      29,  0.98, 20},
        {1,       9,       9,    0,   4.20,  25.0,      -5.6,   -3.6,       4.5,       1.5,       -1,   0,              2,      24,  1.35, 19},
        {2,       9,       9,    0,   4.20,  25.0,      -4.4,   -1.8,       2.8,       2.3,       -3,   0,              2,      19,  1.49, 18},
        {3,       9,       9,    1,   4.20,  25.0,      -3.4,   -1.25,      1.1,       3,         -5,   0,              2,      15,  1.64, 17},
        {4,       9,       9,    1,   4.20,  25.0,      -2.2,    0.1,       0,         3.5,       -8,   0,              2,      11,  1.79, 16},
        {5,       9,       9,    1,   4.50,  35.0,      -0.7,    0.6,     -12.7,       4,        -14,   0.0002,         0,       0,  1.95, 13},
        {6,       9,       9,    1,   5.4,   75.0,       0.7,    1.0,     -27.7,       4,        -20,   0.0007,         0,       0,  2.5,  11},
        {7,       9,       9,    1,   6.6,  145.0,       1.8,    1.8,     -31.7,       4,        -23,   0.0008,         0,       0,  3.5,   8},
        {8,       9,       9,    1,   6.60, 145.0,       2.0,    2.0,     -35.7,       4,        -24,   0.0010,         0,       0,  3.5,   0},
        {9,       9,       9,    1,   6.60, 145.0,       2.2,    2.2,     -41.0,       4,        -25,   0.0012,         0,       0,  3.5,   0},
        {10,      9,       9,    1,   6.60, 145.0,       2.2,    2.2,     -42.0,       4,        -26,   0.0013,         0,       0,  3.5,   0}
    };
