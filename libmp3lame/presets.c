...
int apply_abr_preset(lame_global_flags*  gfp, int preset, int enforce)
{
    ...
    const abr_presets_t abr_switch_map [] = {
        /* kbps  quant q_s safejoint nsmsfix st_lrm  st_s  ns-bass scale ath4_curve, interch , sfscale */
        {   8,   9,    9,  0,        0   ,    6.60, 145  ,  0,      0.95,        11,  0.0012 ,       1}, /*   8, impossible to use in stereo */
        {  16,   9,    9,  0,        0   ,    6.60, 145  ,  0,      0.95,        11,  0.0010 ,       1}, /*  16 */
        {  24,   9,    9,  0,        0   ,    6.60, 145  ,  0,      0.95,        11,  0.0010 ,       1}, /*  24 */
        {  32,   9,    9,  0,        0   ,    6.60, 145  ,  0,      0.95,        11,  0.0010 ,       1}, /*  32 */
        {  40,   9,    9,  0,        0   ,    6.60, 145  ,  0,      0.95,        11,  0.0009 ,       1}, /*  40 */
        {  48,   9,    9,  0,        0   ,    6.60, 145  ,  0,      0.95,        11,  0.0009 ,       1}, /*  48 */
        {  56,   9,    9,  0,        0   ,    6.60, 145  ,  0,      0.95,        11,  0.0008 ,       1}, /*  56 */
        {  64,   9,    9,  0,        0   ,    6.60, 145  ,  0,      0.95,        11,  0.0008 ,       1}, /*  64 */
        {  80,   9,    9,  0,        0   ,    6.60, 145  ,  0,      0.95,        10,  0.0007 ,       1}, /*  80 */
        {  96,   9,    9,  0,        2.50,    6.60, 145  ,  0,      0.95,         8,  0.0006 ,       1}, /*  96 */
        { 112,   9,    9,  0,        2.25,    6.60, 145  ,  0,      0.95,         7,  0.0005 ,       1}, /* 112 */
        { 128,   9,    9,  0,        1.95,    6.40, 140  ,  0,      0.95,         5,  0.0002 ,       1}, /* 128 */
        { 160,   9,    9,  1,        1.79,    6.00, 135  ,  0,      0.95,         4,  0      ,       1}, /* 160 */
        { 192,   9,    9,  1,        1.49,    5.60, 125  ,  0,      0.97,         3,  0      ,       0}, /* 192 */
        { 224,   9,    9,  1,        1.25,    5.20, 125  ,  0,      0.98,         2,  0      ,       0}, /* 224 */
        { 256,   9,    9,  1,        0.97,    5.20, 125  ,  0,      1.00,         1,  0      ,       0}, /* 256 */
        { 320,   9,    9,  1,        0.90,    5.20, 125  ,  0,      1.00,         0,  0      ,       0}  /* 320 */
                                       };
...
int apply_preset(lame_global_flags*  gfp, int preset, int enforce)
{
    ...
    case V4: { /*MEDIUM*/
        ...
        case vbr_rh: {
            ...
            SET_OPTION(maskingadjust, 1.0, 0);
            SET_OPTION(maskingadjust_short, .6, 0);
            SET_OPTION(ATHlower, -10.95, 0);
    ...
    case V1: {
        ...
        case vbr_rh: {
            ...
            SET_OPTION(maskingadjust_short, -2.5, 0);
            SET_OPTION(ATHlower, 0.2, 0);
        ...
        default: {
            ...
            lame_set_exp_nspsytune(gfp, lame_get_exp_nspsytune(gfp) | 2); /* safejoint */
            SET_OPTION(msfix, 1.35, -1);
            SET_OPTION(maskingadjust, -2.8, 0);
            SET_OPTION(maskingadjust_short, -4.3, 0);
            SET_OPTION(ATHlower, 4.3, 0);
            SET_OPTION(ATHcurve, 1.5, -1);
            /* modify sfb21 by 3.75 dB plus ns-treble=0                  */
            lame_set_exp_nspsytune(gfp, lame_get_exp_nspsytune(gfp) | (15 << 20));
    ...
    case V0: { /*EXTREME*/
        ...
        default: {
            ...
            lame_set_exp_nspsytune(gfp, lame_get_exp_nspsytune(gfp) | 2); /* safejoint */
            SET_OPTION(msfix, .97, -1);
            SET_OPTION(maskingadjust, -3.0, 0);
            SET_OPTION(maskingadjust_short, -4.6, 0);
