...
typedef struct {
    ...
    /*vbr_q  qcomp_l  qcomp_s  expY  st_lrm   st_s  mask adj_l  adj_s  ath_lower  ath_curve  ath_sens  interChR  safejoint sfb21mod  msfix */
        {0,       9,       9,    0,   4.20,  25.0,      -7.0,   -4.0,       7.5,       1,          0,   0,              2,      29,  0.97, 15},
        {1,       9,       9,    0,   4.20,  25.0,      -5.6,   -3.6,       4.5,       1.5,        0,   0,              2,      24,  1.35, 15},
        {2,       9,       9,    0,   4.20,  25.0,      -4.4,   -1.8,       2,         2,          0,   0,              2,      19,  1.49, 15},
...
/*#define TEST_0812*/
    ...
    /*vbr_q  qcomp_l  qcomp_s  expY  st_lrm   st_s  mask adj_l  adj_s  ath_lower  ath_curve  ath_sens  interChR  safejoint sfb21mod  msfix */
        {0,       9,       9,    0,   4.20,  25.0,      -7.0,   -7.0,       7.5,       1,          0,   0,              2,      29,  0.977, 12},
        {1,       9,       9,    0,   4.20,  25.0,      -5.6,   -5.6,       4.5,       1.5,       -1,   0,              2,      25,  1.122, 11},
        {2,       9,       9,    0,   4.20,  25.0,      -4.2,   -4.2,       2.8,       2.0,       -3,   0,              2,      21,  1.288, 10},
        {3,       9,       9,    1,   4.20,  25.0,      -3.4,   -3.4,       1.1,       2.0,       -5,   0,              2,      17,  1.479,  8},
        {4,       9,       9,    1,   4.20,  25.0,      -2.0,   -2.0,       0.5,       2.0,       -8,   0,              2,      11,  1.698,  6},
        {5,       9,       9,    1,   4.20,  25.0,      -0.6,   -0.6,       0,         2.0,      -10,   0.0002,         0,       8,  1.950,  4},
        {6,       9,       9,    1,   4.50,  50.0,       0.8,    0.8,      -8.0,       2.0,      -14,   0.0004,         0,       6,  2.239,  2},
        {7,       9,       9,    1,   4.80,  75.0,       1.8,    1.8,     -18.0,       2.1,      -18,   0.0008,         0,       4,  2.570,  0},
        {8,       9,       9,    1,   5.10, 100.0,       2.2,    2.2,     -22.5,       2.2,      -22,   0.0010,         0,       3,  2.951, -8},
        {9,       9,       9,    1,   5.40, 125.0,       2.5,    2.5,     -25.0,       2.3,      -24,   0.0012,         0,       2,  3.388, -8},
        {10,      9,       9,    1,   5.70, 150.0,       2.6,    2.6,     -27.5,       2.5,      -26,   0.0013,         0,       1,  3.500, -8}
    };
