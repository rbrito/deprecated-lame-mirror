...
struct {
    ...
    {   8,  1,    1,  2000,  0.7,   0.90, 11,  -4, 0.0012, 1e3, 0.2, 0.6},
    {  16,  1,    1,  3700,  0.7,   0.90, 11,  -4, 0.0010, 1e3, 0.2, 0.6},
    {  24,  1,    1,  3900,  0.7,   0.90, 11,  -4, 0.0010, 20., 0.2, 0.6},
    {  32,  1,    1,  5500,  0.7,   0.90, 11,  -4, 0.0010, 20., 0.2, 0.6},
    {  40,  1,    1,  7000,  0.7,   0.90, 11,  -3, 0.0009, 20., 0.2, 0.6},
    {  48,  1,    1,  7500,  0.7,   0.90, 11,  -3, 0.0009, 20., 0.2, 0.6},
    {  56,  1,    1, 10000,  0.7,   0.90, 11,  -3, 0.0008, 5.0, 0.2, 0.5},
    {  64,  1,    0, 12000,  0.4,   0.90, 10,  -2, 0.0008, 3.0, 0.2, 0.4},
    {  80,  1,    0, 14500,  0.4,   0.93, 10,  -2, 0.0007, 3.0, 0.1, 0.3},
    {  96,  1,    0, 15300,  0.2,   0.93,  8,  -2, 0.0006, 2.5, 0.05, 0.2},
    { 112,  1,    0, 16000,  0.2,   0.93,  7,  -2, 0.0005, 2.5, 0.04, 0.1},
